...
public partial class Python3BaseListener : IPython3Listener {
	...
	/// <summary>
	/// Enter a parse tree produced by <see cref="Python3Parser.@string"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterString([NotNull] Python3Parser.StringContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="Python3Parser.@string"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitString([NotNull] Python3Parser.StringContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="Python3Parser.number"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterNumber([NotNull] Python3Parser.NumberContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="Python3Parser.number"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitNumber([NotNull] Python3Parser.NumberContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="Python3Parser.integer"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterInteger([NotNull] Python3Parser.IntegerContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="Python3Parser.integer"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitInteger([NotNull] Python3Parser.IntegerContext context) { }
